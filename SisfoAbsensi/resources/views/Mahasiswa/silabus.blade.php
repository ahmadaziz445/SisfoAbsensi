                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Silabus</h2>
												<p>Selamat Datang di Halaman<span class="bread-ntd"> Silabus</span></p>
											</div>
										</div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3 col-md-3 col-sm-3 col-xs-12">
                        ...
                        <div class="hpanel responsive-mg-b-30">
                            <div class="panel-body file-manager-usac">
                                <h3>6 MB Digunakan</h3>
                                <p> 6% Dari Semua Penyimpananmu</p>
                                <div class="progress full m-t-xs">
                                    <div style="width: 6%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="65" role="progressbar" class=" progress-bar progress-bar-info">
                                        6%
                                    </div>
                                </div>
                                <p><b>Catt </b>Untuk Maksimal Penyimpanan Data Sebanyak <b> 100 MB </b></p>
                            </div>
                        </div>
                    </div>
