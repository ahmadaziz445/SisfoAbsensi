...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/bootstrap/scan.css') }}">
    <!-- modernizr JS
		============================================ -->
    <script src="{{ asset('js/vendor/modernizr-2.8.3.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/adapter.min.js') }}"></script>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												...
												<p>Selamat Datang di Halaman<span class="bread-ntd"> Absen Sekarang</span></p>
											</div>
										</div>
                                    </div>
                                </div>
